...
The Fermi energy, $E_F$, must be between the dopant ionisation energy, $E_d$, and the energy needed to add a carrier to the sample, $E_C$, since $E_d$ is the highest occupied state at $T = 0K$. 
